        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group mb-5">
                    ...
                    <?php
                    $nums = 1;
                    $query = "SELECT DISTINCT(marca) FROM cocina WHERE estado = '1' ORDER BY id ASC";
                ...
                <div class="list-group mb-5">
                    <h3>Color</h3>
                        <?php
                        $query = "
                        SELECT DISTINCT(color) FROM cocina WHERE estado = '1' ORDER BY color ASC";
                        $statement = $conn->prepare($query);
                        $statement->execute();
                        $result = $statement->fetchAll();
                        foreach ($result as $row) {
                ...
                <div class="list-group mb-5">
                    ...
                    <div style="height: 400px; overflow-y: auto; overflow-x: hidden;">
                        <?php
                        $query = "
                        SELECT  DISTINCT(categoria) FROM cocina WHERE estado = '1' ORDER BY categoria ASC";
                        $statement = $conn->prepare($query);
                        $statement->execute();
                        $result = $statement->fetchAll();
                        foreach ($result as $row) {
...
<script>
    $(document).ready(function() {
        ...
        function filter_data() {
            ...
            $.ajax({
                url: "filter_data/fetch_data_cocina.php",
                method: "POST",
                data: {
                    action: action,
                    marca: marca,
